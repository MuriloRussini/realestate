    ...
    <div class="bgc-white p-20 bd">
      ...
      <div class="mT-30">
        <form method="POST" action="{{ route('admin.listings.update', ['slug' => $listing->slug, 'id' => $listing->id]) }}">
          ...
          <a href="{{ route('admin.listings.delete', ['slug' => $listing->slug, 'id' => $listing->id]) }}" class="btn btn-danger btn-color" onclick="return confirm('Are you sure you want to delete this listing?')">Delete</a>
        </form>
      </div>
    </div>
  </div>
